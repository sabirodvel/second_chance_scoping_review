...
print(combined_choro_bar)

# ggsave(filename = here::here("images/combined_choro_bar.svg"),
#        plot = combined_choro_bar, height = 10, width = 13, bg = "white")

ggsave(
  filename = here::here("images/combined_choro_bar.tiff"),
  plot = combined_choro_bar,
  height = 10,
  width = 13,
  units = "in",
  dpi = 300,
...
# Save image
ggsave(filename = here("images/surgeries_lollipop_annotated.tiff"), 
       bg = "white", 
       plot = lollipop, 
       width = 7, 
       height = 5, 
