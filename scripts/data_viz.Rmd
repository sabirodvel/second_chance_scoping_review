...
```{r barplot of study distribution, eval = F}
...
data_tree_2 <- treemap(specific_pathology_distribution,
        ...
        type = "index",                    
        palette = "YlGnBu",
        bg.labels = rgb(1, 1, 1, alpha = 0.1),  # Make background of labels transparent
        align.labels = list(
              c("left", "top"),  # Alignment for general group
              c("center", "center")  # Alignment for specific pathology
        ),
        fontsize.labels = c(12,9),  # Adjust label font size
        fontcolor.labels = c("white","white"),  # Label font color
